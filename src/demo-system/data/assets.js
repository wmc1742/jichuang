...
export const icons = {
  ...
  artifactFolder: `${assetRoot}/agent-2/icons/artifact-folder.svg`,
  actorEdit: `${assetRoot}/agent-2/icons/actor-edit.svg`,
  actorSave: `${assetRoot}/agent-2/icons/actor-save.svg`,
  actorVoice: `${assetRoot}/agent-2/icons/actor-voice.svg`,
