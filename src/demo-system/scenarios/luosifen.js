...
export const scenarioRuns = Object.freeze({
  1: { thinking: { title: '正在思考···' }, elapsed: '用时5s', outputIds: ['campaign-question-copy', 'campaign-selection'] },
  2: {
    thinking: { title: '正在思考···' }, elapsed: '用时3m20s',
    execution: {
  ...
  3: {
    thinking: { title: '正在思考···' }, elapsed: '用时4m12s',
    execution: {
      title: '开始执行···', detail: '1m30s',
  ...
  4: {
    thinking: { title: '正在思考···' }, elapsed: '用时1m2s',
    execution: {
  ...
  5: { thinking: { title: '正在思考···' }, elapsed: '用时12s', outputIds: ['character-confirm-copy', 'character-confirmation'] },
  6: {
    thinking: { title: '正在思考···' }, elapsed: '用时20s',
    execution: {
      title: '开始执行···', detail: '1m30s',
  ...
  7: { thinking: { title: '正在思考···' }, elapsed: '用时5s', outputIds: ['video-suggestion', 'video-confirmation'] },
  8: {
    thinking: { title: '正在思考···' }, elapsed: '用时9m12s',
    execution: {
      title: '开始执行···', detail: '1m30s',
      blocks: [
